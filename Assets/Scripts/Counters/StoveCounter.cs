...
public class StoveCounter : BaseCounter, IHasProgress
{
            ...
            switch (state)
            {
                ...
                case State.Frying:
                    ...
                    if (fryingTimer > fryingRecipeSO.fryingTimerMax)
                    {
                        ...
                        GetKitchenObjectType.SpawnKitchenObject(fryingRecipeSO.output, this);
                ...
                case State.Fried:
                    ...
                    if (burningTimer > burningRecipeSO.burningTimerMax)
                    {
                        ...
                        GetKitchenObjectType.SpawnKitchenObject(burningRecipeSO.output, this);
    ...
    {
        FryingRecipeScriptableObject fryingRecipeSO = GetFryingRecipeSOWithInput(inputKitchemObjectSO);
